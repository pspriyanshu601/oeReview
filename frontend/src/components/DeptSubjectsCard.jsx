...
export const DeptSubjectsCard = ({ subject }) => {
    return (
        <div className="w-64 p-4">
            <div className="bg-gray-900 text-white p-6 flex flex-col justify-between h-40 shadow-whiteBottom rounded-lg transform transition-transform hover:scale-105 cursor-pointer">
                <div>
